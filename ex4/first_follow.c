...
char calc_first[MAX_COUNT][MAX_LENGTH];

// Stores the final result of the Follow Sets
char calc_follow[MAX_COUNT][MAX_LENGTH];
int m = 0;

// Stores the production rules
char production[MAX_COUNT][MAX_COUNT];
char f[MAX_COUNT], first[MAX_COUNT];
int k;
char ck;
int e;
